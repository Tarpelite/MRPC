...
class ParanmtProcessor(DataProcessor):
    """Processor for Param-nmt"""
    def get_train_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {}".format(os.path.join(data_dir, "para-nmt-50m.txt")))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "para-nmt-50m.txt")), "train")
